  ...
  return (
    <footer className="bg-[#43302e] flex flex-col justify-center rounded-tl-3xl rounded-tr-3xl pt-10 pb-6 px-6">
      <div className="max-w-6xl mx-auto flex-col md:flex-row px-4 flex justify-between items-center md:items-start gap-10 mb-6 text-center md:text-left">
        ...
        <div className="flex justify-center md:justify-end gap-6 mt-3" style={{ fill: "#4C3A2C" }}>
          {/* <!-- Discord --> */}
          ...
          {/* <!-- Instagram --> */}
          <a href="https://instagram.com/lachiechie" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 text-[#FFFBF0]"
              fill="#4C3A2C"
          ...
          {/* <!-- Linkedin --> */}
          <a href="https://www.linkedin.com/in/grazielac/" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 text-[#FFFBF0]"
              fill="#4C3A2C"
          ...
          {/* <!-- Github --> */}
          <a href="https://github.com/grazielac" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 text-[#FFFBF0]"
              fill="#4C3A2C"
